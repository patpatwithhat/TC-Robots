...
public class CustomListAdapterConnectedRobots extends RecyclerView.Adapter<CustomListAdapterConnectedRobots.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            textView = (TextView) view.findViewById(R.id.tv_robot_name);
        }
    ...
    public CustomListAdapterConnectedRobots(String[] localDataSet) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.list_view_element_robot, viewGroup, false);
